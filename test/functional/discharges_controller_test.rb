...
class DischargesControllerTest < ActionController::TestCase
  ...
  test "should create discharge" do
    assert_difference('Discharge.count') do
      post :create, discharge: { active: @discharge.active, dropreason_id: @discharge.dropreason_id, ipdays: @discharge.ipdays, otherdetail: @discharge.otherdetail, phpvisits: @discharge.phpvisits }
    end
  ...
  test "should update discharge" do
    put :update, id: @discharge, discharge: { active: @discharge.active, dropreason_id: @discharge.dropreason_id, ipdays: @discharge.ipdays, otherdetail: @discharge.otherdetail, phpvisits: @discharge.phpvisits }
    assert_redirected_to discharge_path(assigns(:discharge))
  end
